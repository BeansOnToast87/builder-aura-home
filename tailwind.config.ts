  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        subster: {
          purple: "hsl(var(--subster-purple))" /* #B68298 dusty rose */,
          "purple-light": "hsl(var(--subster-purple-light))",
          "purple-dark": "hsl(var(--subster-purple-dark))",
          navy: "hsl(var(--subster-navy))" /* #6E779E soft navy */,
          "navy-light": "hsl(var(--subster-navy-light))",
          green: "hsl(var(--subster-green))" /* #B2D9AD mint green */,
